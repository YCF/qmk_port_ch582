...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_all(/* 0: qwerty */
                     ...
                     KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_RALT, LT(1, KC_RCTL), KC_LEFT, KC_DOWN, KC_RIGHT),
    [1] = LAYOUT_all(/* 1: fn */
                     KC_GRV, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_DELETE, _______,
                     _______, _______, KC_UP, _______, _______, _______, _______, KC_INSERT, KC_HOME, KC_PAGE_UP, _______, _______, _______, _______, _______,
                     _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, KC_DELETE, KC_END, KC_PAGE_DOWN, _______, _______, RGB_TOG, _______,
